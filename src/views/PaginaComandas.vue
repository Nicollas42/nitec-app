<template>
    <div class="tela_gestao_comandas p-8 bg-gray-100 h-full font-sans flex flex-col overflow-y-auto">
        
        <header class="cabecalho_pagina shrink-0 flex justify-between items-center bg-white p-6 rounded-2xl shadow-sm border border-gray-200 mb-8">
            <div>
            ...
            <div class="filtros_status hidden md:flex gap-2 bg-gray-100 p-1 rounded-xl border border-gray-200">
                ...
                <table class="tabela_comandas w-full text-left border-collapse">
                    ...
                    <tbody class="corpo_tabela divide-y divide-gray-50">
                        <tr v-if="comandas_filtradas.length === 0">
                            <td colspan="6" class="p-8 text-center text-gray-400 font-medium italic">Nenhuma comanda encontrada.</td>
                        </tr>
